...
async function updateAMS(telemetryObject) {
  ...
  var tray1Color = telemetryObject.ams.ams[1].tray[0].tray_color;
  var tray1Material = telemetryObject.ams.ams[1].tray[0].tray_sub_brands;
  var tray1FilamentType = telemetryObject.ams.ams[1].tray[0].tray_type;
  var tray1Type = "";
  var tray1UID = telemetryObject.ams.ams[1].tray[0].tag_uid;
  var tray1Remaining = telemetryObject.ams.ams[1].tray[0].remain;
  ...
  var tray2Color = telemetryObject.ams.ams[1].tray[1].tray_color;
  var tray2Material = telemetryObject.ams.ams[1].tray[1].tray_sub_brands;
  var tray2FilamentType = telemetryObject.ams.ams[1].tray[1].tray_type;
  var tray2Type = "";
  var tray2UID = telemetryObject.ams.ams[1].tray[1].tag_uid;
  var tray2Remaining = telemetryObject.ams.ams[1].tray[1].remain;
  ...
  var tray3Color = telemetryObject.ams.ams[1].tray[2].tray_color;
  var tray3Material = telemetryObject.ams.ams[1].tray[2].tray_sub_brands;
  var tray3FilamentType = telemetryObject.ams.ams[1].tray[2].tray_type;
  var tray3Type = "";
  var tray3UID = telemetryObject.ams.ams[1].tray[2].tag_uid;
  var tray3Remaining = telemetryObject.ams.ams[1].tray[2].remain;
  ...
  var tray4Color = telemetryObject.ams.ams[1].tray[3].tray_color;
  var tray4Material = telemetryObject.ams.ams[1].tray[3].tray_sub_brands;
  var tray4FilamentType = telemetryObject.ams.ams[1].tray[3].tray_type;
  var tray4Type = "";
  var tray4UID = telemetryObject.ams.ams[1].tray[3].tag_uid;
  var tray4Remaining = telemetryObject.ams.ams[1].tray[3].remain;
